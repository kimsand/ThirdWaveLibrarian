...
struct BanksView_Previews: PreviewProvider {
    ...
    @State static var banks = Banks(banks: [
        Bank(patches: [dummyPatch1], title: "Bank 1"),
        Bank(patches: [dummyPatch2], title: "Bank 2"),
        Bank(patches: [dummyPatch3], title: "Bank 3"),
        Bank(patches: [dummyPatch4], title: "Bank 4"),
        Bank(patches: [dummyPatch5], title: "Bank 5")
        ]
    )
